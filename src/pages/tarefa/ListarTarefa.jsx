...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="contained" color="info" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="medium" /></Button>            
                      </TableCell>
                      <TableCell align="center">
                        <Button variant="contained" color="secondary" onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="medium" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
        ...
        <CardActions>
            <Button size="small" color="warning"  variant="contained" onClick={handleOpen}>Criar Tarefa</Button>
            <Button size="small" color="inherit" variant="contained">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
